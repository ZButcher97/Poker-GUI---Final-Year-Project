...
{
    this->mutexCard.lock();
    string ReturnString = this->CardUID;
    this->mutexCard.unlock();
    return ReturnString;
}
...
bool MFRC522::IsReaderResponsive()
{
  uint8_t val = this->PCD_ReadRegister(this->TxControlReg);   
  return(val & 0x03);
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                         Custom code within standard method
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    uint8_t val = PCD_ReadRegister(TxControlReg);   //Initilastion check to ensure TX1 and TX2 are enabled
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  //This is nessisary as there is an issue with readers becoming unresponsive in unknown circumstances. 
  //This will check to state of TX1 and RX1, if these are not 0b11 respectivly, then assume unresponsive and restart reader. 
  //This is a bodge/temp fix as the root of the issue needs addresing, however this allows operation of program.
  if(!this->IsReaderResponsive())
  {
      this->PCD_Init();
  }
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
